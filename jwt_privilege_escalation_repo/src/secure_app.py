...
JWT_EXP_SECONDS = 15 * 60

def require_strong_secret(secret: str) -> None:
    if not secret or len(secret) < 32:
        raise RuntimeError("JWT_SECRET must be set and at least 32 characters. Use: openssl rand -base64 32")
...
@app.get("/")
def home():
    return "Secure mode. Try POST /api/login then GET /api/me and GET /admin"
